<footer class="flex justify-between items-center p-4 border-t border-gray-200 text-sm text-muted-text">
    ...
    <div class="flex items-center justify-center gap-1">
        ...
        <p>{{ now()->year }} Habitual. Todos los derechos reservados</p>
    </div>
</footer>

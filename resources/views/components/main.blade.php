<main class="flex flex-col justify-center items-center text-xl">
    <section class="bg-[#F6F7F8] gap-20">
        <div class="max-w-sm md:max-w-xl">
            ...
            <p class="mt-4 text-muted-text">Habitual te ayuda a crecer y mantener hábitos positivos con un enfoque personalizado y herramientas intuitivas.</p>
            <div class="mt-8 flex gap-4">
                <x-primary-button>Comenzar ahora</x-primary-button>
                <x-secondary-button>Ver demostración</x-secondary-button>
            </div>
        </div>
    ...
    <section class="flex-col">
        ...
        <p class="mt-4 text-muted-text">Descubre cómo Habitual puede ayudarte a alcanzar tus metas:</p>
    ...
    <section class="bg-[#EAF0F7] flex flex-col items-center text-center gap-6 py-4">
        ...
        <p class="mt-2 text-muted-text">Regístrate hoy y comienza a construir los hábitos que siempre has deseado.</p>
        <x-primary-button>Comenzar ahora</x-primary-button>
    </section>
</main>
